...
const processSteps = [
  {
    ...
    description: "Apply in just 60 seconds for your loan fast, simple, no credit worries.",
    delay: 0,
    isDown: false,
  },
  {
    ...
    description: "Select the loan option that fits your needs with full control.",
    delay: 100,
    isDown: true,
  },
  {
  ...
  },
  {
    ...
    description: "Get your approved loan in your account quickly flexible and hassle-free.",
    delay: 300,
    isDown: true,
  },
];
